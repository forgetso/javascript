...
- Fix `signIn()` timing out with concurrent Playwright workers by de-duplicating route handler registration and adding retry with exponential backoff for transient FAPI errors (429, 502, 503, 504). ([#8173](https://github.com/clerk/javascript/pull/8173)) by [@jacekradko](https://github.com/jacekradko)
...
- Add retry logic with exponential backoff for testing token fetch on 429 and 5xx responses. ([#8138](https://github.com/clerk/javascript/pull/8138)) by [@jacekradko](https://github.com/jacekradko)
...
- Export `createAgentTestingTask` helper for creating agent tasks via the Clerk Backend API from both `@clerk/testing/playwright` and `@clerk/testing/cypress` subpaths. ([#7783](https://github.com/clerk/javascript/pull/7783)) by [@tmilewski](https://github.com/tmilewski)
...
- Improved keyless selectors. ([#7834](https://github.com/clerk/javascript/pull/7834)) by [@wobsoriano](https://github.com/wobsoriano)
